...
namespace MVC_Hospital_project.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IdentificationNumber,Gender,DateOfBirth")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IdentificationNumber,Gender,DateOfBirth")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
